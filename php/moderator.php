                ...
                <table id="table1" >
                    <thead>
                        <tr >
                            ...
                            <th  scope="col">answer 1</td>
                            <th  scope="col">answer 2</td>
                            <th  scope="col">answer 3</td>
                            <th scope="col">answer 4</td>
                            <th  scope="col">Correct answer 1</th>
                            <th  scope="col">Correct answer 2</th>
                            <th  scope="col">Correct answer 3</th>
                            <th  scope="col">Correct answer 4</th>
                    ...
                    <tr>
                        ...
                        <td data-label="answer 1"><?php echo $row["ans1"]; ?></td>
                        <td data-label="answer 2"><?php echo $row["ans2"]; ?></td>
                        <td data-label="answer 3"><?php echo $row["ans3"]; ?></td>
                        <td data-label="answer 4"><?php echo $row["ans4"]; ?></td>
                        <td data-label="Correct answer 1"><?php echo $row["correct_ans1"]; ?></td>
                        <td data-label="Correct answer 2"><?php echo $row["correct_ans2"]; ?></td>
                        <td data-label="Correct answer 3"><?php echo $row["correct_ans3"]; ?></td>
                        <td data-label="Correct answer 4"><?php echo $row["correct_ans4"]; ?></td>
            ...
            <article>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td data-label="answer 3"><?php echo $row["ans3"]; ?></td>
                        <td data-label="answer 4"><?php echo $row["ans4"]; ?></td>
                        <td data-label="Correct answer"><?php echo $row["correct_answer"]; ?></td>
                    ...
                    <div class="popup" id="popup-2">
                        ...
                        <div class="content">
                            ...
                            <div style="display: grid;grid-template-columns: repeat(1,1fr); grid-column-gap: 5px;">
                                ...
                                <label for="ans2_a"><b>answer 1</b></label>
                                <input type="text" name="ans2_a" id="ans2_a">

                                <label for="ans2_b"><b>answer 2</b></label>
                                <input type="text" name="ans2_b" id="ans2_b">

                                <label for="ans2_c"><b>answer 3</b></label>
                                <input type="text" name="ans2_c" id="ans2_c">

                                <label for="ans2_d"><b>answer 4</b></label>
                            ...
                            <div class="content">
                                ...
                                <form class="col-5 col-s-7 row" action="edit-question.php?type=4" method="post">
                                    <div style="display: grid;grid-template-columns: repeat(1,1fr); grid-column-gap: 5px;">
                                        ...
                                        <label for="answer4"><b>answer</b></label>
        ...
        <script>
            ...
            for (var i=0; i<table.rows.length; i++) {
                table.rows[i].onclick = function() {
                    ...
                    document.getElementById("correct_answer").value = this.cells[6].innerHTML;
            ...
            for (var i=0; i<table.rows.length; i++) {
                table.rows[i].onclick = function() {
                    ...
                    document.getElementById("answer3").value = this.cells[2].innerHTML;
            ...
            for (var i=0; i<table.rows.length; i++) {
                table.rows[i].onclick = function() {
                    ...
                    document.getElementById("answer4").value = this.cells[2].innerHTML;
