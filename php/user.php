    ...
    <div class="col-12 col-s-12">
        <article>
            <table class="styled-table" >
                    <tr style="background: rgba(255, 115, 0, 0.116);">
                        <th >Username</th>
                        <th >Date</th>
                        <th >Difficulty</th>
                        <th >Score</th>
    ...
    <div class="col-12 col-s-12 ButtonsBox">
        ...
        <div id="dropDown1" class="dropdown-container">
            <form action="edit-user.php?type=addQuestion1" method="post">
                ...
                <div style="display: grid;grid-template-columns: repeat(4,1fr); grid-column-gap: 5px;">
                    ...
                    <p><b>answer 3</b></p>
                    <p><b>answer 4</b></p>
                    <input type="checkbox" name="correct_answer1_a" value="correct_answer1">
                    <input type="checkbox" name="correct_answer1_b" value="correct_answer2">
                    <input type="checkbox" name="correct_answer1_c" value="correct_answer3">
                    <input type="checkbox" name="correct_answer1_d" value="correct_answer4">
                </div>
        ...
        <div id="dropDown2" class="dropdown-container">
            <form action="edit-user.php?type=addQuestion2" method="post">
                ...
                <p><b>answer 4</b></p>
                <input type="text" name="answer_4" id="answer_4">

                <p><b>correct_answer</b></p>
                <input type="text" name="correct_answer2" id="correct_answer">
        ...
        <button class="dropdownButton3" onclick="myFunction3()">Text completion</button>
        ...
        <form action="edit-user.php?type=addQuestion4" method="post">
                ...
                <div style="display: grid;grid-template-columns: repeat(2,1fr); grid-column-gap: 5px;">
                    <p><b>True</b></p>
                    <p><b>False</b></p>
                    <input type="radio" name="answer_t_f"  value="True">
                    <input type="radio" name="answer_t_f"  value="False">
                </div>
                <p><b>Difficulty</b></p>
                <div style="display: grid;grid-template-columns: repeat(3,1fr); grid-column-gap: 5px;">
                    <p><b>Easy</b></p>
